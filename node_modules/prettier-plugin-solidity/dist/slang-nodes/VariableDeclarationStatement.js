...
export class VariableDeclarationStatement extends SlangNode {
    constructor(ast, collected, options) {
        ...
        this.variableType = extractVariant(new VariableDeclarationType(ast.variableType, collected, options));
        if (ast.storageLocation) {
            this.storageLocation = new StorageLocation(ast.storageLocation, collected);
        }
