...
export class TupleDeconstructionStatement extends SlangNode {
    constructor(ast, collected, options) {
        ...
        this.elements = new TupleDeconstructionElements(ast.elements, collected, options);
        this.expression = extractVariant(new Expression(ast.expression, collected, options));
