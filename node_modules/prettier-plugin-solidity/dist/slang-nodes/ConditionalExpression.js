...
export class ConditionalExpression extends SlangNode {
    constructor(ast, collected, options) {
        ...
        this.operand = extractVariant(new Expression(ast.operand, collected, options));
        this.trueExpression = extractVariant(new Expression(ast.trueExpression, collected, options));
        this.falseExpression = extractVariant(new Expression(ast.falseExpression, collected, options));
