...
import { printAssignmentRightSide, printSeparatedList } from '../common/printer-helpers.js';
...
const initialValue = (node, path, print) => {
    ...
    return [
        ' =',
        printAssignmentRightSide(path.call(print, 'initialValue'), node.initialValue)
    ];
};
