...
nonterminalKindCABI[nonterminalKindCABI['StorageLayoutSpecifier'] = 139] = 'StorageLayoutSpecifier';
nonterminalKindCABI[nonterminalKindCABI['StorageLocation'] = 140] = 'StorageLocation';
nonterminalKindCABI[nonterminalKindCABI['StringExpression'] = 141] = 'StringExpression';
nonterminalKindCABI[nonterminalKindCABI['StringLiteral'] = 142] = 'StringLiteral';
nonterminalKindCABI[nonterminalKindCABI['StringLiterals'] = 143] = 'StringLiterals';
nonterminalKindCABI[nonterminalKindCABI['StructDefinition'] = 144] = 'StructDefinition';
nonterminalKindCABI[nonterminalKindCABI['StructMember'] = 145] = 'StructMember';
nonterminalKindCABI[nonterminalKindCABI['StructMembers'] = 146] = 'StructMembers';
nonterminalKindCABI[nonterminalKindCABI['ThrowStatement'] = 147] = 'ThrowStatement';
nonterminalKindCABI[nonterminalKindCABI['TryStatement'] = 148] = 'TryStatement';
nonterminalKindCABI[nonterminalKindCABI['TupleDeconstructionElement'] = 149] = 'TupleDeconstructionElement';
nonterminalKindCABI[nonterminalKindCABI['TupleDeconstructionElements'] = 150] = 'TupleDeconstructionElements';
nonterminalKindCABI[nonterminalKindCABI['TupleDeconstructionStatement'] = 151] = 'TupleDeconstructionStatement';
nonterminalKindCABI[nonterminalKindCABI['TupleExpression'] = 152] = 'TupleExpression';
nonterminalKindCABI[nonterminalKindCABI['TupleMember'] = 153] = 'TupleMember';
nonterminalKindCABI[nonterminalKindCABI['TupleValue'] = 154] = 'TupleValue';
nonterminalKindCABI[nonterminalKindCABI['TupleValues'] = 155] = 'TupleValues';
nonterminalKindCABI[nonterminalKindCABI['TypeExpression'] = 156] = 'TypeExpression';
nonterminalKindCABI[nonterminalKindCABI['TypeName'] = 157] = 'TypeName';
nonterminalKindCABI[nonterminalKindCABI['TypedTupleMember'] = 158] = 'TypedTupleMember';
nonterminalKindCABI[nonterminalKindCABI['UncheckedBlock'] = 159] = 'UncheckedBlock';
nonterminalKindCABI[nonterminalKindCABI['UnicodeStringLiteral'] = 160] = 'UnicodeStringLiteral';
nonterminalKindCABI[nonterminalKindCABI['UnicodeStringLiterals'] = 161] = 'UnicodeStringLiterals';
nonterminalKindCABI[nonterminalKindCABI['UnnamedFunctionAttribute'] = 162] = 'UnnamedFunctionAttribute';
nonterminalKindCABI[nonterminalKindCABI['UnnamedFunctionAttributes'] = 163] = 'UnnamedFunctionAttributes';
nonterminalKindCABI[nonterminalKindCABI['UnnamedFunctionDefinition'] = 164] = 'UnnamedFunctionDefinition';
nonterminalKindCABI[nonterminalKindCABI['UntypedTupleMember'] = 165] = 'UntypedTupleMember';
nonterminalKindCABI[nonterminalKindCABI['UserDefinedValueTypeDefinition'] = 166] = 'UserDefinedValueTypeDefinition';
nonterminalKindCABI[nonterminalKindCABI['UsingAlias'] = 167] = 'UsingAlias';
nonterminalKindCABI[nonterminalKindCABI['UsingClause'] = 168] = 'UsingClause';
nonterminalKindCABI[nonterminalKindCABI['UsingDeconstruction'] = 169] = 'UsingDeconstruction';
nonterminalKindCABI[nonterminalKindCABI['UsingDeconstructionSymbol'] = 170] = 'UsingDeconstructionSymbol';
nonterminalKindCABI[nonterminalKindCABI['UsingDeconstructionSymbols'] = 171] = 'UsingDeconstructionSymbols';
nonterminalKindCABI[nonterminalKindCABI['UsingDirective'] = 172] = 'UsingDirective';
nonterminalKindCABI[nonterminalKindCABI['UsingOperator'] = 173] = 'UsingOperator';
nonterminalKindCABI[nonterminalKindCABI['UsingTarget'] = 174] = 'UsingTarget';
nonterminalKindCABI[nonterminalKindCABI['VariableDeclarationStatement'] = 175] = 'VariableDeclarationStatement';
nonterminalKindCABI[nonterminalKindCABI['VariableDeclarationType'] = 176] = 'VariableDeclarationType';
nonterminalKindCABI[nonterminalKindCABI['VariableDeclarationValue'] = 177] = 'VariableDeclarationValue';
nonterminalKindCABI[nonterminalKindCABI['VersionExpression'] = 178] = 'VersionExpression';
nonterminalKindCABI[nonterminalKindCABI['VersionExpressionSet'] = 179] = 'VersionExpressionSet';
nonterminalKindCABI[nonterminalKindCABI['VersionExpressionSets'] = 180] = 'VersionExpressionSets';
nonterminalKindCABI[nonterminalKindCABI['VersionLiteral'] = 181] = 'VersionLiteral';
nonterminalKindCABI[nonterminalKindCABI['VersionOperator'] = 182] = 'VersionOperator';
nonterminalKindCABI[nonterminalKindCABI['VersionPragma'] = 183] = 'VersionPragma';
nonterminalKindCABI[nonterminalKindCABI['VersionRange'] = 184] = 'VersionRange';
nonterminalKindCABI[nonterminalKindCABI['VersionTerm'] = 185] = 'VersionTerm';
nonterminalKindCABI[nonterminalKindCABI['WhileStatement'] = 186] = 'WhileStatement';
nonterminalKindCABI[nonterminalKindCABI['YulArguments'] = 187] = 'YulArguments';
nonterminalKindCABI[nonterminalKindCABI['YulAssignmentOperator'] = 188] = 'YulAssignmentOperator';
nonterminalKindCABI[nonterminalKindCABI['YulBlock'] = 189] = 'YulBlock';
nonterminalKindCABI[nonterminalKindCABI['YulBreakStatement'] = 190] = 'YulBreakStatement';
nonterminalKindCABI[nonterminalKindCABI['YulColonAndEqual'] = 191] = 'YulColonAndEqual';
nonterminalKindCABI[nonterminalKindCABI['YulContinueStatement'] = 192] = 'YulContinueStatement';
nonterminalKindCABI[nonterminalKindCABI['YulDefaultCase'] = 193] = 'YulDefaultCase';
nonterminalKindCABI[nonterminalKindCABI['YulEqualAndColon'] = 194] = 'YulEqualAndColon';
nonterminalKindCABI[nonterminalKindCABI['YulExpression'] = 195] = 'YulExpression';
nonterminalKindCABI[nonterminalKindCABI['YulForStatement'] = 196] = 'YulForStatement';
nonterminalKindCABI[nonterminalKindCABI['YulFunctionCallExpression'] = 197] = 'YulFunctionCallExpression';
nonterminalKindCABI[nonterminalKindCABI['YulFunctionDefinition'] = 198] = 'YulFunctionDefinition';
nonterminalKindCABI[nonterminalKindCABI['YulIfStatement'] = 199] = 'YulIfStatement';
nonterminalKindCABI[nonterminalKindCABI['YulLabel'] = 200] = 'YulLabel';
nonterminalKindCABI[nonterminalKindCABI['YulLeaveStatement'] = 201] = 'YulLeaveStatement';
nonterminalKindCABI[nonterminalKindCABI['YulLiteral'] = 202] = 'YulLiteral';
nonterminalKindCABI[nonterminalKindCABI['YulParameters'] = 203] = 'YulParameters';
nonterminalKindCABI[nonterminalKindCABI['YulParametersDeclaration'] = 204] = 'YulParametersDeclaration';
nonterminalKindCABI[nonterminalKindCABI['YulPath'] = 205] = 'YulPath';
nonterminalKindCABI[nonterminalKindCABI['YulPaths'] = 206] = 'YulPaths';
nonterminalKindCABI[nonterminalKindCABI['YulReturnsDeclaration'] = 207] = 'YulReturnsDeclaration';
nonterminalKindCABI[nonterminalKindCABI['YulStackAssignmentOperator'] = 208] = 'YulStackAssignmentOperator';
nonterminalKindCABI[nonterminalKindCABI['YulStackAssignmentStatement'] = 209] = 'YulStackAssignmentStatement';
nonterminalKindCABI[nonterminalKindCABI['YulStatement'] = 210] = 'YulStatement';
nonterminalKindCABI[nonterminalKindCABI['YulStatements'] = 211] = 'YulStatements';
nonterminalKindCABI[nonterminalKindCABI['YulSwitchCase'] = 212] = 'YulSwitchCase';
nonterminalKindCABI[nonterminalKindCABI['YulSwitchCases'] = 213] = 'YulSwitchCases';
nonterminalKindCABI[nonterminalKindCABI['YulSwitchStatement'] = 214] = 'YulSwitchStatement';
nonterminalKindCABI[nonterminalKindCABI['YulValueCase'] = 215] = 'YulValueCase';
nonterminalKindCABI[nonterminalKindCABI['YulVariableAssignmentStatement'] = 216] = 'YulVariableAssignmentStatement';
nonterminalKindCABI[nonterminalKindCABI['YulVariableDeclarationStatement'] = 217] = 'YulVariableDeclarationStatement';
nonterminalKindCABI[nonterminalKindCABI['YulVariableDeclarationValue'] = 218] = 'YulVariableDeclarationValue';
nonterminalKindCABI[nonterminalKindCABI['YulVariableNames'] = 219] = 'YulVariableNames';
...
terminalKindCABI[terminalKindCABI['AfterKeyword'] = 8] = 'AfterKeyword';
terminalKindCABI[terminalKindCABI['AliasKeyword'] = 9] = 'AliasKeyword';
terminalKindCABI[terminalKindCABI['Ampersand'] = 10] = 'Ampersand';
terminalKindCABI[terminalKindCABI['AmpersandAmpersand'] = 11] = 'AmpersandAmpersand';
terminalKindCABI[terminalKindCABI['AmpersandEqual'] = 12] = 'AmpersandEqual';
terminalKindCABI[terminalKindCABI['AnonymousKeyword'] = 13] = 'AnonymousKeyword';
terminalKindCABI[terminalKindCABI['ApplyKeyword'] = 14] = 'ApplyKeyword';
terminalKindCABI[terminalKindCABI['AsKeyword'] = 15] = 'AsKeyword';
terminalKindCABI[terminalKindCABI['AssemblyKeyword'] = 16] = 'AssemblyKeyword';
terminalKindCABI[terminalKindCABI['Asterisk'] = 17] = 'Asterisk';
terminalKindCABI[terminalKindCABI['AsteriskAsterisk'] = 18] = 'AsteriskAsterisk';
terminalKindCABI[terminalKindCABI['AsteriskEqual'] = 19] = 'AsteriskEqual';
terminalKindCABI[terminalKindCABI['AtKeyword'] = 20] = 'AtKeyword';
...
terminalKindCABI[terminalKindCABI['EqualColon'] = 62] = 'EqualColon';
terminalKindCABI[terminalKindCABI['EqualEqual'] = 63] = 'EqualEqual';
terminalKindCABI[terminalKindCABI['EqualGreaterThan'] = 64] = 'EqualGreaterThan';
terminalKindCABI[terminalKindCABI['ErrorKeyword'] = 65] = 'ErrorKeyword';
terminalKindCABI[terminalKindCABI['EtherKeyword'] = 66] = 'EtherKeyword';
terminalKindCABI[terminalKindCABI['EventKeyword'] = 67] = 'EventKeyword';
terminalKindCABI[terminalKindCABI['ExperimentalKeyword'] = 68] = 'ExperimentalKeyword';
terminalKindCABI[terminalKindCABI['ExternalKeyword'] = 69] = 'ExternalKeyword';
terminalKindCABI[terminalKindCABI['FallbackKeyword'] = 70] = 'FallbackKeyword';
terminalKindCABI[terminalKindCABI['FalseKeyword'] = 71] = 'FalseKeyword';
terminalKindCABI[terminalKindCABI['FinalKeyword'] = 72] = 'FinalKeyword';
terminalKindCABI[terminalKindCABI['FinneyKeyword'] = 73] = 'FinneyKeyword';
terminalKindCABI[terminalKindCABI['FixedKeyword'] = 74] = 'FixedKeyword';
terminalKindCABI[terminalKindCABI['ForKeyword'] = 75] = 'ForKeyword';
terminalKindCABI[terminalKindCABI['FromKeyword'] = 76] = 'FromKeyword';
terminalKindCABI[terminalKindCABI['FunctionKeyword'] = 77] = 'FunctionKeyword';
terminalKindCABI[terminalKindCABI['GlobalKeyword'] = 78] = 'GlobalKeyword';
terminalKindCABI[terminalKindCABI['GreaterThan'] = 79] = 'GreaterThan';
terminalKindCABI[terminalKindCABI['GreaterThanEqual'] = 80] = 'GreaterThanEqual';
terminalKindCABI[terminalKindCABI['GreaterThanGreaterThan'] = 81] = 'GreaterThanGreaterThan';
terminalKindCABI[terminalKindCABI['GreaterThanGreaterThanEqual'] = 82] = 'GreaterThanGreaterThanEqual';
terminalKindCABI[terminalKindCABI['GreaterThanGreaterThanGreaterThan'] = 83] = 'GreaterThanGreaterThanGreaterThan';
terminalKindCABI[terminalKindCABI['GreaterThanGreaterThanGreaterThanEqual'] = 84] = 'GreaterThanGreaterThanGreaterThanEqual';
terminalKindCABI[terminalKindCABI['GweiKeyword'] = 85] = 'GweiKeyword';
terminalKindCABI[terminalKindCABI['HexKeyword'] = 86] = 'HexKeyword';
terminalKindCABI[terminalKindCABI['HexLiteral'] = 87] = 'HexLiteral';
terminalKindCABI[terminalKindCABI['HoursKeyword'] = 88] = 'HoursKeyword';
terminalKindCABI[terminalKindCABI['Identifier'] = 89] = 'Identifier';
terminalKindCABI[terminalKindCABI['IfKeyword'] = 90] = 'IfKeyword';
terminalKindCABI[terminalKindCABI['ImmutableKeyword'] = 91] = 'ImmutableKeyword';
terminalKindCABI[terminalKindCABI['ImplementsKeyword'] = 92] = 'ImplementsKeyword';
terminalKindCABI[terminalKindCABI['ImportKeyword'] = 93] = 'ImportKeyword';
terminalKindCABI[terminalKindCABI['InKeyword'] = 94] = 'InKeyword';
terminalKindCABI[terminalKindCABI['IndexedKeyword'] = 95] = 'IndexedKeyword';
terminalKindCABI[terminalKindCABI['InlineKeyword'] = 96] = 'InlineKeyword';
terminalKindCABI[terminalKindCABI['IntKeyword'] = 97] = 'IntKeyword';
terminalKindCABI[terminalKindCABI['InterfaceKeyword'] = 98] = 'InterfaceKeyword';
terminalKindCABI[terminalKindCABI['InternalKeyword'] = 99] = 'InternalKeyword';
terminalKindCABI[terminalKindCABI['IsKeyword'] = 100] = 'IsKeyword';
terminalKindCABI[terminalKindCABI['LayoutKeyword'] = 101] = 'LayoutKeyword';
terminalKindCABI[terminalKindCABI['LessThan'] = 102] = 'LessThan';
terminalKindCABI[terminalKindCABI['LessThanEqual'] = 103] = 'LessThanEqual';
terminalKindCABI[terminalKindCABI['LessThanLessThan'] = 104] = 'LessThanLessThan';
terminalKindCABI[terminalKindCABI['LessThanLessThanEqual'] = 105] = 'LessThanLessThanEqual';
terminalKindCABI[terminalKindCABI['LetKeyword'] = 106] = 'LetKeyword';
terminalKindCABI[terminalKindCABI['LibraryKeyword'] = 107] = 'LibraryKeyword';
terminalKindCABI[terminalKindCABI['MacroKeyword'] = 108] = 'MacroKeyword';
terminalKindCABI[terminalKindCABI['MappingKeyword'] = 109] = 'MappingKeyword';
terminalKindCABI[terminalKindCABI['MatchKeyword'] = 110] = 'MatchKeyword';
terminalKindCABI[terminalKindCABI['MemoryKeyword'] = 111] = 'MemoryKeyword';
terminalKindCABI[terminalKindCABI['Minus'] = 112] = 'Minus';
terminalKindCABI[terminalKindCABI['MinusEqual'] = 113] = 'MinusEqual';
terminalKindCABI[terminalKindCABI['MinusGreaterThan'] = 114] = 'MinusGreaterThan';
terminalKindCABI[terminalKindCABI['MinusMinus'] = 115] = 'MinusMinus';
terminalKindCABI[terminalKindCABI['MinutesKeyword'] = 116] = 'MinutesKeyword';
terminalKindCABI[terminalKindCABI['ModifierKeyword'] = 117] = 'ModifierKeyword';
terminalKindCABI[terminalKindCABI['MultiLineComment'] = 118] = 'MultiLineComment';
terminalKindCABI[terminalKindCABI['MultiLineNatSpecComment'] = 119] = 'MultiLineNatSpecComment';
terminalKindCABI[terminalKindCABI['MutableKeyword'] = 120] = 'MutableKeyword';
terminalKindCABI[terminalKindCABI['NewKeyword'] = 121] = 'NewKeyword';
terminalKindCABI[terminalKindCABI['NullKeyword'] = 122] = 'NullKeyword';
terminalKindCABI[terminalKindCABI['OfKeyword'] = 123] = 'OfKeyword';
terminalKindCABI[terminalKindCABI['OpenBrace'] = 124] = 'OpenBrace';
terminalKindCABI[terminalKindCABI['OpenBracket'] = 125] = 'OpenBracket';
terminalKindCABI[terminalKindCABI['OpenParen'] = 126] = 'OpenParen';
terminalKindCABI[terminalKindCABI['OverrideKeyword'] = 127] = 'OverrideKeyword';
terminalKindCABI[terminalKindCABI['PartialKeyword'] = 128] = 'PartialKeyword';
terminalKindCABI[terminalKindCABI['PayableKeyword'] = 129] = 'PayableKeyword';
terminalKindCABI[terminalKindCABI['Percent'] = 130] = 'Percent';
terminalKindCABI[terminalKindCABI['PercentEqual'] = 131] = 'PercentEqual';
terminalKindCABI[terminalKindCABI['Period'] = 132] = 'Period';
terminalKindCABI[terminalKindCABI['Plus'] = 133] = 'Plus';
terminalKindCABI[terminalKindCABI['PlusEqual'] = 134] = 'PlusEqual';
terminalKindCABI[terminalKindCABI['PlusPlus'] = 135] = 'PlusPlus';
terminalKindCABI[terminalKindCABI['PragmaKeyword'] = 136] = 'PragmaKeyword';
terminalKindCABI[terminalKindCABI['PrivateKeyword'] = 137] = 'PrivateKeyword';
terminalKindCABI[terminalKindCABI['PromiseKeyword'] = 138] = 'PromiseKeyword';
terminalKindCABI[terminalKindCABI['PublicKeyword'] = 139] = 'PublicKeyword';
terminalKindCABI[terminalKindCABI['PureKeyword'] = 140] = 'PureKeyword';
terminalKindCABI[terminalKindCABI['QuestionMark'] = 141] = 'QuestionMark';
terminalKindCABI[terminalKindCABI['ReceiveKeyword'] = 142] = 'ReceiveKeyword';
terminalKindCABI[terminalKindCABI['ReferenceKeyword'] = 143] = 'ReferenceKeyword';
terminalKindCABI[terminalKindCABI['RelocatableKeyword'] = 144] = 'RelocatableKeyword';
terminalKindCABI[terminalKindCABI['ReturnKeyword'] = 145] = 'ReturnKeyword';
terminalKindCABI[terminalKindCABI['ReturnsKeyword'] = 146] = 'ReturnsKeyword';
terminalKindCABI[terminalKindCABI['RevertKeyword'] = 147] = 'RevertKeyword';
terminalKindCABI[terminalKindCABI['SMTCheckerKeyword'] = 148] = 'SMTCheckerKeyword';
terminalKindCABI[terminalKindCABI['SealedKeyword'] = 149] = 'SealedKeyword';
terminalKindCABI[terminalKindCABI['SecondsKeyword'] = 150] = 'SecondsKeyword';
terminalKindCABI[terminalKindCABI['Semicolon'] = 151] = 'Semicolon';
terminalKindCABI[terminalKindCABI['SingleLineComment'] = 152] = 'SingleLineComment';
terminalKindCABI[terminalKindCABI['SingleLineNatSpecComment'] = 153] = 'SingleLineNatSpecComment';
terminalKindCABI[terminalKindCABI['SingleQuotedHexStringLiteral'] = 154] = 'SingleQuotedHexStringLiteral';
terminalKindCABI[terminalKindCABI['SingleQuotedStringLiteral'] = 155] = 'SingleQuotedStringLiteral';
terminalKindCABI[terminalKindCABI['SingleQuotedUnicodeStringLiteral'] = 156] = 'SingleQuotedUnicodeStringLiteral';
terminalKindCABI[terminalKindCABI['SingleQuotedVersionLiteral'] = 157] = 'SingleQuotedVersionLiteral';
terminalKindCABI[terminalKindCABI['SizeOfKeyword'] = 158] = 'SizeOfKeyword';
terminalKindCABI[terminalKindCABI['Slash'] = 159] = 'Slash';
terminalKindCABI[terminalKindCABI['SlashEqual'] = 160] = 'SlashEqual';
terminalKindCABI[terminalKindCABI['SolidityKeyword'] = 161] = 'SolidityKeyword';
terminalKindCABI[terminalKindCABI['StaticKeyword'] = 162] = 'StaticKeyword';
terminalKindCABI[terminalKindCABI['StorageKeyword'] = 163] = 'StorageKeyword';
terminalKindCABI[terminalKindCABI['StringKeyword'] = 164] = 'StringKeyword';
terminalKindCABI[terminalKindCABI['StructKeyword'] = 165] = 'StructKeyword';
terminalKindCABI[terminalKindCABI['SuperKeyword'] = 166] = 'SuperKeyword';
terminalKindCABI[terminalKindCABI['SupportsKeyword'] = 167] = 'SupportsKeyword';
terminalKindCABI[terminalKindCABI['SwitchKeyword'] = 168] = 'SwitchKeyword';
terminalKindCABI[terminalKindCABI['SzaboKeyword'] = 169] = 'SzaboKeyword';
terminalKindCABI[terminalKindCABI['ThisKeyword'] = 170] = 'ThisKeyword';
terminalKindCABI[terminalKindCABI['ThrowKeyword'] = 171] = 'ThrowKeyword';
terminalKindCABI[terminalKindCABI['Tilde'] = 172] = 'Tilde';
terminalKindCABI[terminalKindCABI['TransientKeyword'] = 173] = 'TransientKeyword';
terminalKindCABI[terminalKindCABI['TrueKeyword'] = 174] = 'TrueKeyword';
terminalKindCABI[terminalKindCABI['TryKeyword'] = 175] = 'TryKeyword';
terminalKindCABI[terminalKindCABI['TypeDefKeyword'] = 176] = 'TypeDefKeyword';
terminalKindCABI[terminalKindCABI['TypeKeyword'] = 177] = 'TypeKeyword';
terminalKindCABI[terminalKindCABI['TypeOfKeyword'] = 178] = 'TypeOfKeyword';
terminalKindCABI[terminalKindCABI['UfixedKeyword'] = 179] = 'UfixedKeyword';
terminalKindCABI[terminalKindCABI['UintKeyword'] = 180] = 'UintKeyword';
terminalKindCABI[terminalKindCABI['UncheckedKeyword'] = 181] = 'UncheckedKeyword';
terminalKindCABI[terminalKindCABI['UsingKeyword'] = 182] = 'UsingKeyword';
terminalKindCABI[terminalKindCABI['VarKeyword'] = 183] = 'VarKeyword';
terminalKindCABI[terminalKindCABI['VersionSpecifier'] = 184] = 'VersionSpecifier';
terminalKindCABI[terminalKindCABI['ViewKeyword'] = 185] = 'ViewKeyword';
terminalKindCABI[terminalKindCABI['VirtualKeyword'] = 186] = 'VirtualKeyword';
terminalKindCABI[terminalKindCABI['WeeksKeyword'] = 187] = 'WeeksKeyword';
terminalKindCABI[terminalKindCABI['WeiKeyword'] = 188] = 'WeiKeyword';
terminalKindCABI[terminalKindCABI['WhileKeyword'] = 189] = 'WhileKeyword';
terminalKindCABI[terminalKindCABI['Whitespace'] = 190] = 'Whitespace';
terminalKindCABI[terminalKindCABI['YearsKeyword'] = 191] = 'YearsKeyword';
terminalKindCABI[terminalKindCABI['YulAbstractKeyword'] = 192] = 'YulAbstractKeyword';
terminalKindCABI[terminalKindCABI['YulAfterKeyword'] = 193] = 'YulAfterKeyword';
terminalKindCABI[terminalKindCABI['YulAliasKeyword'] = 194] = 'YulAliasKeyword';
terminalKindCABI[terminalKindCABI['YulAnonymousKeyword'] = 195] = 'YulAnonymousKeyword';
terminalKindCABI[terminalKindCABI['YulApplyKeyword'] = 196] = 'YulApplyKeyword';
terminalKindCABI[terminalKindCABI['YulAsKeyword'] = 197] = 'YulAsKeyword';
terminalKindCABI[terminalKindCABI['YulAssemblyKeyword'] = 198] = 'YulAssemblyKeyword';
terminalKindCABI[terminalKindCABI['YulAutoKeyword'] = 199] = 'YulAutoKeyword';
terminalKindCABI[terminalKindCABI['YulBoolKeyword'] = 200] = 'YulBoolKeyword';
terminalKindCABI[terminalKindCABI['YulBreakKeyword'] = 201] = 'YulBreakKeyword';
terminalKindCABI[terminalKindCABI['YulBytesKeyword'] = 202] = 'YulBytesKeyword';
terminalKindCABI[terminalKindCABI['YulCallDataKeyword'] = 203] = 'YulCallDataKeyword';
terminalKindCABI[terminalKindCABI['YulCaseKeyword'] = 204] = 'YulCaseKeyword';
terminalKindCABI[terminalKindCABI['YulCatchKeyword'] = 205] = 'YulCatchKeyword';
terminalKindCABI[terminalKindCABI['YulConstantKeyword'] = 206] = 'YulConstantKeyword';
terminalKindCABI[terminalKindCABI['YulConstructorKeyword'] = 207] = 'YulConstructorKeyword';
terminalKindCABI[terminalKindCABI['YulContinueKeyword'] = 208] = 'YulContinueKeyword';
terminalKindCABI[terminalKindCABI['YulContractKeyword'] = 209] = 'YulContractKeyword';
terminalKindCABI[terminalKindCABI['YulCopyOfKeyword'] = 210] = 'YulCopyOfKeyword';
terminalKindCABI[terminalKindCABI['YulDaysKeyword'] = 211] = 'YulDaysKeyword';
terminalKindCABI[terminalKindCABI['YulDecimalLiteral'] = 212] = 'YulDecimalLiteral';
terminalKindCABI[terminalKindCABI['YulDefaultKeyword'] = 213] = 'YulDefaultKeyword';
terminalKindCABI[terminalKindCABI['YulDefineKeyword'] = 214] = 'YulDefineKeyword';
terminalKindCABI[terminalKindCABI['YulDeleteKeyword'] = 215] = 'YulDeleteKeyword';
terminalKindCABI[terminalKindCABI['YulDoKeyword'] = 216] = 'YulDoKeyword';
terminalKindCABI[terminalKindCABI['YulElseKeyword'] = 217] = 'YulElseKeyword';
terminalKindCABI[terminalKindCABI['YulEmitKeyword'] = 218] = 'YulEmitKeyword';
terminalKindCABI[terminalKindCABI['YulEnumKeyword'] = 219] = 'YulEnumKeyword';
terminalKindCABI[terminalKindCABI['YulEtherKeyword'] = 220] = 'YulEtherKeyword';
terminalKindCABI[terminalKindCABI['YulEventKeyword'] = 221] = 'YulEventKeyword';
terminalKindCABI[terminalKindCABI['YulExternalKeyword'] = 222] = 'YulExternalKeyword';
terminalKindCABI[terminalKindCABI['YulFallbackKeyword'] = 223] = 'YulFallbackKeyword';
terminalKindCABI[terminalKindCABI['YulFalseKeyword'] = 224] = 'YulFalseKeyword';
terminalKindCABI[terminalKindCABI['YulFinalKeyword'] = 225] = 'YulFinalKeyword';
terminalKindCABI[terminalKindCABI['YulFinneyKeyword'] = 226] = 'YulFinneyKeyword';
terminalKindCABI[terminalKindCABI['YulFixedKeyword'] = 227] = 'YulFixedKeyword';
terminalKindCABI[terminalKindCABI['YulForKeyword'] = 228] = 'YulForKeyword';
terminalKindCABI[terminalKindCABI['YulFunctionKeyword'] = 229] = 'YulFunctionKeyword';
terminalKindCABI[terminalKindCABI['YulGweiKeyword'] = 230] = 'YulGweiKeyword';
terminalKindCABI[terminalKindCABI['YulHexKeyword'] = 231] = 'YulHexKeyword';
terminalKindCABI[terminalKindCABI['YulHexLiteral'] = 232] = 'YulHexLiteral';
terminalKindCABI[terminalKindCABI['YulHoursKeyword'] = 233] = 'YulHoursKeyword';
terminalKindCABI[terminalKindCABI['YulIdentifier'] = 234] = 'YulIdentifier';
terminalKindCABI[terminalKindCABI['YulIfKeyword'] = 235] = 'YulIfKeyword';
terminalKindCABI[terminalKindCABI['YulImmutableKeyword'] = 236] = 'YulImmutableKeyword';
terminalKindCABI[terminalKindCABI['YulImplementsKeyword'] = 237] = 'YulImplementsKeyword';
terminalKindCABI[terminalKindCABI['YulImportKeyword'] = 238] = 'YulImportKeyword';
terminalKindCABI[terminalKindCABI['YulInKeyword'] = 239] = 'YulInKeyword';
terminalKindCABI[terminalKindCABI['YulIndexedKeyword'] = 240] = 'YulIndexedKeyword';
terminalKindCABI[terminalKindCABI['YulInlineKeyword'] = 241] = 'YulInlineKeyword';
terminalKindCABI[terminalKindCABI['YulIntKeyword'] = 242] = 'YulIntKeyword';
terminalKindCABI[terminalKindCABI['YulInterfaceKeyword'] = 243] = 'YulInterfaceKeyword';
terminalKindCABI[terminalKindCABI['YulInternalKeyword'] = 244] = 'YulInternalKeyword';
terminalKindCABI[terminalKindCABI['YulIsKeyword'] = 245] = 'YulIsKeyword';
terminalKindCABI[terminalKindCABI['YulLeaveKeyword'] = 246] = 'YulLeaveKeyword';
terminalKindCABI[terminalKindCABI['YulLetKeyword'] = 247] = 'YulLetKeyword';
terminalKindCABI[terminalKindCABI['YulLibraryKeyword'] = 248] = 'YulLibraryKeyword';
terminalKindCABI[terminalKindCABI['YulMacroKeyword'] = 249] = 'YulMacroKeyword';
terminalKindCABI[terminalKindCABI['YulMappingKeyword'] = 250] = 'YulMappingKeyword';
terminalKindCABI[terminalKindCABI['YulMatchKeyword'] = 251] = 'YulMatchKeyword';
terminalKindCABI[terminalKindCABI['YulMemoryKeyword'] = 252] = 'YulMemoryKeyword';
terminalKindCABI[terminalKindCABI['YulMinutesKeyword'] = 253] = 'YulMinutesKeyword';
terminalKindCABI[terminalKindCABI['YulModifierKeyword'] = 254] = 'YulModifierKeyword';
terminalKindCABI[terminalKindCABI['YulMutableKeyword'] = 255] = 'YulMutableKeyword';
terminalKindCABI[terminalKindCABI['YulNewKeyword'] = 256] = 'YulNewKeyword';
terminalKindCABI[terminalKindCABI['YulNullKeyword'] = 257] = 'YulNullKeyword';
terminalKindCABI[terminalKindCABI['YulOfKeyword'] = 258] = 'YulOfKeyword';
terminalKindCABI[terminalKindCABI['YulOverrideKeyword'] = 259] = 'YulOverrideKeyword';
terminalKindCABI[terminalKindCABI['YulPartialKeyword'] = 260] = 'YulPartialKeyword';
terminalKindCABI[terminalKindCABI['YulPayableKeyword'] = 261] = 'YulPayableKeyword';
terminalKindCABI[terminalKindCABI['YulPragmaKeyword'] = 262] = 'YulPragmaKeyword';
terminalKindCABI[terminalKindCABI['YulPrivateKeyword'] = 263] = 'YulPrivateKeyword';
terminalKindCABI[terminalKindCABI['YulPromiseKeyword'] = 264] = 'YulPromiseKeyword';
terminalKindCABI[terminalKindCABI['YulPublicKeyword'] = 265] = 'YulPublicKeyword';
terminalKindCABI[terminalKindCABI['YulPureKeyword'] = 266] = 'YulPureKeyword';
terminalKindCABI[terminalKindCABI['YulReceiveKeyword'] = 267] = 'YulReceiveKeyword';
terminalKindCABI[terminalKindCABI['YulReferenceKeyword'] = 268] = 'YulReferenceKeyword';
terminalKindCABI[terminalKindCABI['YulRelocatableKeyword'] = 269] = 'YulRelocatableKeyword';
terminalKindCABI[terminalKindCABI['YulReturnsKeyword'] = 270] = 'YulReturnsKeyword';
terminalKindCABI[terminalKindCABI['YulSealedKeyword'] = 271] = 'YulSealedKeyword';
terminalKindCABI[terminalKindCABI['YulSecondsKeyword'] = 272] = 'YulSecondsKeyword';
terminalKindCABI[terminalKindCABI['YulSizeOfKeyword'] = 273] = 'YulSizeOfKeyword';
terminalKindCABI[terminalKindCABI['YulStaticKeyword'] = 274] = 'YulStaticKeyword';
terminalKindCABI[terminalKindCABI['YulStorageKeyword'] = 275] = 'YulStorageKeyword';
terminalKindCABI[terminalKindCABI['YulStringKeyword'] = 276] = 'YulStringKeyword';
terminalKindCABI[terminalKindCABI['YulStructKeyword'] = 277] = 'YulStructKeyword';
terminalKindCABI[terminalKindCABI['YulSuperKeyword'] = 278] = 'YulSuperKeyword';
terminalKindCABI[terminalKindCABI['YulSupportsKeyword'] = 279] = 'YulSupportsKeyword';
terminalKindCABI[terminalKindCABI['YulSwitchKeyword'] = 280] = 'YulSwitchKeyword';
terminalKindCABI[terminalKindCABI['YulSzaboKeyword'] = 281] = 'YulSzaboKeyword';
terminalKindCABI[terminalKindCABI['YulThisKeyword'] = 282] = 'YulThisKeyword';
terminalKindCABI[terminalKindCABI['YulThrowKeyword'] = 283] = 'YulThrowKeyword';
terminalKindCABI[terminalKindCABI['YulTrueKeyword'] = 284] = 'YulTrueKeyword';
terminalKindCABI[terminalKindCABI['YulTryKeyword'] = 285] = 'YulTryKeyword';
terminalKindCABI[terminalKindCABI['YulTypeDefKeyword'] = 286] = 'YulTypeDefKeyword';
terminalKindCABI[terminalKindCABI['YulTypeKeyword'] = 287] = 'YulTypeKeyword';
terminalKindCABI[terminalKindCABI['YulTypeOfKeyword'] = 288] = 'YulTypeOfKeyword';
terminalKindCABI[terminalKindCABI['YulUfixedKeyword'] = 289] = 'YulUfixedKeyword';
terminalKindCABI[terminalKindCABI['YulUintKeyword'] = 290] = 'YulUintKeyword';
terminalKindCABI[terminalKindCABI['YulUncheckedKeyword'] = 291] = 'YulUncheckedKeyword';
terminalKindCABI[terminalKindCABI['YulUsingKeyword'] = 292] = 'YulUsingKeyword';
terminalKindCABI[terminalKindCABI['YulVarKeyword'] = 293] = 'YulVarKeyword';
terminalKindCABI[terminalKindCABI['YulViewKeyword'] = 294] = 'YulViewKeyword';
terminalKindCABI[terminalKindCABI['YulVirtualKeyword'] = 295] = 'YulVirtualKeyword';
terminalKindCABI[terminalKindCABI['YulWeeksKeyword'] = 296] = 'YulWeeksKeyword';
terminalKindCABI[terminalKindCABI['YulWeiKeyword'] = 297] = 'YulWeiKeyword';
terminalKindCABI[terminalKindCABI['YulWhileKeyword'] = 298] = 'YulWhileKeyword';
terminalKindCABI[terminalKindCABI['YulYearsKeyword'] = 299] = 'YulYearsKeyword';
...
const trampoline0 = rscTableCreateOwn.bind(null, handleTable13);
const trampoline1 = rscTableCreateOwn.bind(null, handleTable14);
const trampoline2 = rscTableCreateOwn.bind(null, handleTable15);
const trampoline3 = rscTableCreateOwn.bind(null, handleTable16);
const trampoline4 = rscTableCreateOwn.bind(null, handleTable4);
const trampoline5 = rscTableCreateOwn.bind(null, handleTable5);
const trampoline6 = rscTableCreateOwn.bind(null, handleTable6);
const trampoline7 = rscTableCreateOwn.bind(null, handleTable7);
const trampoline8 = rscTableCreateOwn.bind(null, handleTable8);
const trampoline9 = rscTableCreateOwn.bind(null, handleTable18);
...
const trampoline18 = rscTableCreateOwn.bind(null, handleTable9);
...
const trampoline20 = rscTableCreateOwn.bind(null, handleTable11);
...
const trampoline22 = rscTableCreateOwn.bind(null, handleTable10);
...
const trampoline28 = rscTableCreateOwn.bind(null, handleTable17);
...
const trampoline31 = rscTableCreateOwn.bind(null, handleTable19);
...
const trampoline33 = rscTableCreateOwn.bind(null, handleTable20);
...
const trampoline36 = rscTableCreateOwn.bind(null, handleTable12);
...
const trampoline38 = rscTableCreateOwn.bind(null, handleTable21);
  ...
  let gen = (function* init () {
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      '[export]nomic-foundation:slang/bindings': {
        '[resource-drop]binding-graph': trampoline37,
        '[resource-drop]built-in-location': trampoline27,
        '[resource-drop]definition': trampoline24,
        '[resource-drop]reference': trampoline25,
        '[resource-drop]user-file-location': trampoline26,
        '[resource-new]binding-graph': trampoline36,
        '[resource-new]built-in-location': trampoline3,
        '[resource-new]definition': trampoline0,
        '[resource-new]reference': trampoline1,
        '[resource-new]user-file-location': trampoline2,
      },
      '[export]nomic-foundation:slang/compilation': {
        '[resource-drop]compilation-unit': trampoline34,
        '[resource-drop]file': trampoline35,
        '[resource-drop]internal-compilation-builder': trampoline32,
        '[resource-new]compilation-unit': trampoline33,
        '[resource-new]file': trampoline38,
        '[resource-new]internal-compilation-builder': trampoline31,
      },
      '[export]nomic-foundation:slang/cst': {
        '[resource-drop]ancestors-iterator': trampoline19,
        '[resource-drop]cursor': trampoline14,
        '[resource-drop]cursor-iterator': trampoline13,
        '[resource-drop]edge': trampoline11,
        '[resource-drop]nonterminal-node': trampoline12,
        '[resource-drop]query': trampoline23,
        '[resource-drop]query-match-iterator': trampoline21,
        '[resource-drop]terminal-node': trampoline15,
        '[resource-new]ancestors-iterator': trampoline18,
        '[resource-new]cursor': trampoline7,
        '[resource-new]cursor-iterator': trampoline8,
        '[resource-new]edge': trampoline6,
        '[resource-new]nonterminal-node': trampoline4,
        '[resource-new]query': trampoline22,
        '[resource-new]query-match-iterator': trampoline20,
        '[resource-new]terminal-node': trampoline5,
        '[resource-rep]edge': trampoline10,
        '[resource-rep]nonterminal-node': trampoline17,
        '[resource-rep]terminal-node': trampoline16,
      },
      '[export]nomic-foundation:slang/parser': {
        '[resource-drop]parse-output': trampoline30,
        '[resource-drop]parser': trampoline29,
        '[resource-new]parse-output': trampoline9,
        '[resource-new]parser': trampoline28,
      },
    ...
    ({ exports: exports3 } = yield instantiateCore(yield module3, {
      '': {
        ...
        '2': trampoline49,
        '20': exports1['nomic-foundation:slang/cst#[dtor]edge'],
        '21': exports1['nomic-foundation:slang/cst#[dtor]cursor'],
        '22': exports1['nomic-foundation:slang/cst#[dtor]cursor-iterator'],
        '23': exports1['nomic-foundation:slang/cst#[dtor]ancestors-iterator'],
        '24': exports1['nomic-foundation:slang/cst#[dtor]query'],
        '25': exports1['nomic-foundation:slang/cst#[dtor]query-match-iterator'],
        '26': exports1['nomic-foundation:slang/cst#[dtor]text-index-extensions'],
        '27': exports1['nomic-foundation:slang/ast#[dtor]selectors'],
        '28': exports1['nomic-foundation:slang/bindings#[dtor]binding-graph'],
        '29': exports1['nomic-foundation:slang/bindings#[dtor]definition'],
        '3': trampoline50,
        '30': exports1['nomic-foundation:slang/bindings#[dtor]reference'],
        '31': exports1['nomic-foundation:slang/bindings#[dtor]user-file-location'],
        '32': exports1['nomic-foundation:slang/bindings#[dtor]built-in-location'],
        '33': exports1['nomic-foundation:slang/parser#[dtor]parser'],
        '34': exports1['nomic-foundation:slang/parser#[dtor]parse-output'],
        '35': exports1['nomic-foundation:slang/compilation#[dtor]internal-compilation-builder'],
        '36': exports1['nomic-foundation:slang/compilation#[dtor]compilation-unit'],
        '37': exports1['nomic-foundation:slang/compilation#[dtor]file'],
        '38': exports1['nomic-foundation:slang/utils#[dtor]language-facts'],
        '4': trampoline51,
        '5': trampoline52,
        '6': trampoline53,
        '7': trampoline54,
    ...
    postReturn0 = exports1['cabi_post_nomic-foundation:slang/bindings#[method]definition.references'];
    ...
    postReturn7 = exports1['cabi_post_nomic-foundation:slang/compilation#[method]file.errors'];
    postReturn8 = exports1['cabi_post_nomic-foundation:slang/utils#[static]language-facts.all-versions'];
    ...
    cstStaticNonterminalNodeCreate = exports1['nomic-foundation:slang/cst#[static]nonterminal-node.create'];
    ...
    cstStaticTerminalNodeCreate = exports1['nomic-foundation:slang/cst#[static]terminal-node.create'];
    ...
    cstStaticEdgeCreateWithTerminal = exports1['nomic-foundation:slang/cst#[static]edge.create-with-terminal'];
    cstStaticEdgeCreateWithNonterminal = exports1['nomic-foundation:slang/cst#[static]edge.create-with-nonterminal'];
    cstMethodEdgeLabel = exports1['nomic-foundation:slang/cst#[method]edge.label'];
    cstMethodEdgeNode = exports1['nomic-foundation:slang/cst#[method]edge.node'];
    ...
    cstStaticTextIndexExtensionsZero = exports1['nomic-foundation:slang/cst#[static]text-index-extensions.zero'];
